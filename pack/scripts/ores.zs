...
createOre("midnight_zinc", 0);
createOre("midnight_fluorite", 0);
createOre("midnight_tin", 0);
createOre("midnight_coal", 0);
createOre("midnight_magnesium", 0);
createOre("midnight_quartz", 0);